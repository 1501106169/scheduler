...
public class PeriodicLIFOSchedulingAlgorithmEx extends SchedulingAlgorithm {
    ...
    private Stack<MyPeriodicTask> readyTaskSet = new Stack<>();
    @Override
    ...
    private ExecuteInfo executeOneJob(){
        ...
        MyPeriodicTask taskToExecute = readyTaskSet.peek();
